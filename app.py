...
if page == "🏠 Home":
    ...
    ">
        ...
        <p style="
            ...
            margin-bottom: 0;
        ">
            Discover customer purchasing patterns, generate
            product recommendations and predict transaction values
    ...
    with c1:
        ...
        ">
            ...
            <div class="metric-description">
                ...
                preprocessing and transaction patterns.
            </div>
    ...
    with c2:
        ...
        ">
            ...
            <div class="metric-description">
                ...
                purchased together using Apriori.
            </div>
    ...
    <div style="
        ...
        border-radius: 20px;
        color: white;
        box-shadow: 0 10px 28px rgba(23,37,84,0.20);
    ">
        ...
        <div style="
            ...
            max-width: 900px;
        ">
            A Feedforward Neural Network analyzes transaction
            features such as Quantity and Unit Price to classify
    ...
    ">
        ...
        <div style="
            ...
            font-size: 14px;
        ">
            ReLU hidden layers • Sigmoid output • Adam optimizer
        </div>
    ...
    with w1:
        ...
        ">
            ...
            <h4 style="color:#17346d;">Dataset</h4>
            <p style="color:#64748b;font-size:13px;">
                Load & prepare retail data
            </p>
        </div>
        """)
    ...
    with w2:
        ...
        ">
            ...
            <h4 style="color:#17346d;">Apriori</h4>
            <p style="color:#64748b;font-size:13px;">
    ...
    with w3:
        ...
        ">
            <div style="font-size:30px;">🤖</div>
            <h4 style="color:#17346d;">Machine Learning</h4>
            <p style="color:#64748b;font-size:13px;">
                Classify transaction values
            </p>
        </div>
        """)
    ...
    with w4:
        ...
        ">
            <div style="font-size:30px;">🧠</div>
            <h4 style="color:#17346d;">Deep Learning</h4>
            <p style="color:#64748b;font-size:13px;">
    ...
    st.html("""
    <div class="footer">
        © 2026 | Market Basket Analysis Project |
